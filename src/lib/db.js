...
export const financialData = {
  ...
  export const appointmentCategories = ["General Dentistry", "Cosmetic Dentistry", "Restorative Dentistry"]

  export const providers = ["Dr. Robert Smith", "Dr. Maddy", "Dr. Robin Jefferson"]
