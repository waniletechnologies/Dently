    ...
    <Table>
      <TableHeader>
        <TableRow className="border-b border-[#e1e1e1]">
          ...
          <TableHead className="text-[#848484] font-medium">Created Date</TableHead>
          <TableHead className="text-[#848484] font-medium">Notes</TableHead>
          <TableHead className="text-[#848484] font-medium text-right">Actions</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {leads.map((lead) => (
          <TableRow key={lead.id} className="border-b border-[#f0f0f0] hover:bg-[#f8f9fa]">
            <TableCell className="font-medium text-[#171717]">{lead.name}</TableCell>
            ...
            <TableCell className="text-[#171717] max-w-[200px] truncate">{lead.notes}</TableCell>
