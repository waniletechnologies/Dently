  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-[#171717]">Lead Details</DialogTitle>
          <p className="text-sm text-[#848484]">Viewing details for {lead.name}</p>
        </DialogHeader>
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="space-y-2">
            ...
            <Select defaultValue={lead.status.toLowerCase()} onValueChange={handleStatusChange}>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <Button className="bg-[#ffa048] hover:bg-[#f68a15] text-white" onClick={handleSaveChanges}>
              Save Changes
            </Button>
          </div>
        </div>
