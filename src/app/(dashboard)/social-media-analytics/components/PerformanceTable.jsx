      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-200">
            <th className="text-left py-3 text-sm font-medium text-gray-600">Campaign Name</th>
            <th className="text-left py-3 text-sm font-medium text-gray-600">Spend (£)</th>
        ...
        <tbody>
          {data.map((campaign, index) => (
            <tr key={index} className="border-b border-gray-100">
              ...
              <td className="py-4">
                <Badge className="bg-green-100 text-green-800 hover:bg-green-100">{campaign.status}</Badge>
              </td>
