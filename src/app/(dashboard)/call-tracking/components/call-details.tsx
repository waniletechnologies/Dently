    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-white border-[#e1e1e1]">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-xl font-semibold text-[#171717]">Call with {callDetail.phoneNumber}</h2>
              ...
              <div className="grid grid-cols-3 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-[#171717] font-medium">{callDetail.phoneNumber}</p>
                </div>
                <div>
                  <p className="text-sm text-[#848484] mb-1">Duration</p>
                  <p className="text-[#171717] font-medium">{callDetail.duration}</p>
                </div>
                <div>
                  <p className="text-sm text-[#848484] mb-1">Agent</p>
                  <p className="text-[#171717] font-medium">{callDetail.agent}</p>
                </div>
              </div>
          ...
          <Card className="bg-white border-[#e1e1e1]">
            ...
            <CardContent>
              ...
              <Button className="bg-[#ffa048] hover:bg-[#f68a15] text-white">Post Comment</Button>
            </CardContent>
          </Card>
        ...
        <div>
          <Card className="bg-white border-[#e1e1e1]">
            <CardHeader>
              <CardTitle className="text-[#171717]">Update Call Status</CardTitle>
              <p className="text-sm text-[#848484]">Update booking and follow-up information for this call.</p>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button
                    variant={callDetail.bookingStatus === "Not Booked" ? "default" : "outline"}
                    className={
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button
                    variant={callDetail.followUpStatus === "Pending" ? "default" : "outline"}
                    className={
              ...
              <Button className="w-full bg-[#ffa048] hover:bg-[#f68a15] text-white">Save Notes</Button>
            </CardContent>
          </Card>
        </div>
      </div>
