...
export default function Integrations() {
  return (
    <div className={`mx-auto bg-white rounded-2xl w-full py-10 px-4 ${inter.className}`}>
    <div className="sm:px-10">
      <h2 className="font-semibold text-[20px] leading-[20px] tracking-normal mb-1">Accounts Connected</h2>
      <p className="font-normal text-base leading-[20px] tracking-normal text-[#8E919F] mb-6">Manage your Accounts</p>
          ...
          >
            ...
            <CardContent className="flex items-center justify-between py-4 px-4">
              ...
              {integration.status === "connected" ? (
                <Button variant="secondary" className="bg-[#09924F] cursor-pointer text-white hover:bg-green-600">
                  Connected
                </Button>
              ) : (
