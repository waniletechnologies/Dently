    ...
    <div className="flex flex-col mt-[32px] gap-4">
      ...
      <section className={SectionStyles}>
        ...
        <p className={DescriptionStyles}>
          ...
          <span className={SpanStyles}>
            ...
            <strong>
              {" "}
              YOUR PRACTICE&apos;S UNIQUE SELLING POINTS{" "}
            </strong> <br /> What makes your practice different from the
            practice down the street? <br />
      ...
      <section className={SectionStyles}>
        ...
        <p className={DescriptionStyles}>
          ...
          appointment we require a <span className={SpanStyles}>
            £COST
          </span>{" "}
