	...
	const renderTaskList = (tasks) => (
		<div className="space-y-4">
			{tasks.map((task) => (
				<div
					key={task.id}
					className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-[#f8f8f8] rounded-lg gap-3"
				>
					<div className="flex items-start sm:items-center gap-3">
						<div className="w-1 h-12 bg-[#ffa048] rounded-full shrink-0" />
						<div>
	...
	return (
		<Card className="bg-white border-[#e1e1e1]">
			<CardHeader className="pb-4">
				<CardTitle className="text-[#171717] text-lg">
					Today&apos;s Tasks
				</CardTitle>
			</CardHeader>
			<CardContent>
				<Tabs defaultValue="today" className="w-full">
					...
					<div className="overflow-x-hidden">
						...
						<TabsContent value="recommendations" className="mt-0">
							<div className="text-center py-8 text-[#848484]">
