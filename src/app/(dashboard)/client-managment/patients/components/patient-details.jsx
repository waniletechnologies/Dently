      ...
      <div className="flex sm:items-center justify-between sm:flex-row flex-col gap-3">
        <div className="flex items-center gap-4">
          <Link href="/client-management/patients">
            <Button variant="ghost" className="flex items-center gap-2 cursor-pointer text-[#848484] hover:text-[#171717]">
              <ArrowLeft className="h-4 w-4" />
              Back to Patients list
            </Button>
          </Link>
        </div>
        <Button className="bg-primary cursor-pointer text-white">Book Appointment</Button>
      </div>
