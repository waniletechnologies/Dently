...
export default function AppointmentsPage() {
	...
	const handleAddAppointment = (appointmentData) => {
		...
		setSuccessMessage(
			`${appointmentData.patient} appointment has been created successfully!`,
		);
	...
	const handleCancelAppointment = (appointmentId, patientName) => {
		setConfirmMessage(
			`Do you really want to cancel ${patientName}'s appointment?`,
		);
		setConfirmAction(() => () => {
			setAppointments(
			...
			setSuccessMessage(
				`${patientName} appointment has been cancelled successfully!`,
			);
			setIsSuccessModalOpen(true);
		});
