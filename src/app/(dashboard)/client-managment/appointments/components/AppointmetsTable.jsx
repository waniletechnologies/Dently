...
import { CheckCircle, Edit, MoreHorizontal, Trash2 } from 'lucide-react';
			...
			<Table>
				<TableHeader>
					<TableRow className="border-b border-gray-200">
						<TableHead className="font-medium text-gray-900 py-4">
							Patient
						</TableHead>
								...
								<DropdownMenu>
									...
									<DropdownMenuContent align="end" className="w-48">
										...
										<DropdownMenuItem
											...
											onClick={() =>
												onCancelAppointment(appointment.id, appointment.patient)
											}
										>
