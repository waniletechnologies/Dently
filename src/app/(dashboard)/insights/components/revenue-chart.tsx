        ...
        <div className="h-56 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              ...
              <XAxis dataKey="month" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: "#848484" }} />
              <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: "#848484" }} tickFormatter={v => `${(v/1000).toFixed(0)}k`} />
