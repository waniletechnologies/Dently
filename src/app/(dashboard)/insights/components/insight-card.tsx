...
export default function InsightCard({ title, bullets, tags, subtext }: InsightCardProps) {
  return (
    <Card className={`mb-4 ${inter.className}`}>
      <CardContent className="px-6 py-3">
        <h3 className="font-semibold text-base leading-[16px] tracking-normal mb-2">{title}</h3>
        ...
        <div className="font-light text-[10px] leading-[22px] tracking-normal text-[#636363]">{subtext}</div>
      </CardContent>
    </Card>
  );
} 