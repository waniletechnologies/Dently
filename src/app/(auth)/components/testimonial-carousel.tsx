...
const testimonials = [
	{
		quote:
			"Our revenue has increased 350% under Dr. Spencer's guidance. His input has been absolutely integral to our success.",
		name: 'Dr. Emily Ross',
...
export function TestimonialCarousel() {
	...
	return (
		<div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-[90%] max-w-xl bg-[#936849/70 backdrop-blur-md rounded-xl p-6 shadow-lg flex flex-col gap-3">
			...
			<div>
				<div className="font-bold text-[#FFFFFF] text-[24px] leading-[20px] tracking-[-0.03em] mb-1">
					{testimonial.name}
				</div>
				<div className="font-medium text-[#FFFFFF] text-[13px] leading-[20px] tracking-[-0.03em]">
					{testimonial.title}
				</div>
