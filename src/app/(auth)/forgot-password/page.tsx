		...
		<AuthLayout>
			<div className="flex flex-col items-center justify-center w-full min-h-screen">
				<div className="mx-auto w-full max-w-md px-12">
					<h3 className="font-bold text-[24px] leading-[20px] tracking-normal mb-1 text-left">
						I&apos;ve forgotten my password
					</h3>
					<p className="font-normal text-custom-gray text-xs leading-[20px] tracking-normal mb-6 text-left">
					...
					<form className="space-y-6">
						<div className="flex flex-col gap-2">
							<Label
								htmlFor="email"
								className="font-medium text-sm leading-[20px] tracking-normal text-left"
							>
								Email
							</Label>
