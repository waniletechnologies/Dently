      ...
      <div className="flex flex-col items-center justify-center w-full min-h-screen">
        ...
        <div className="bg-[#FEFEFE] border border-gray-200 rounded-2xl shadow-lg px-10 py-6 w-full max-w-md flex flex-col items-center">
          ...
          <form className="space-y-5 w-full">
            ...
            <Button className='w-full rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-semibold flex items-center justify-center gap-2 py-2'>Sign in <LogIn size={18}/></Button>
          </form>
