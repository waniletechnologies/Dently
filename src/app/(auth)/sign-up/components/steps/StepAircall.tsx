...
import { MdCheck, MdCheckCircle, MdPhone } from 'react-icons/md';
							...
							<div>
								...
								<ul className="space-y-1 text-sm">
									<li className="flex items-center gap-2 text-[#848484]">
										<MdCheck size={16} className="text-[#52884B]" /> Call
										transcription enabled
									</li>
									<li className="flex items-center gap-2 text-[#848484]">
										<MdCheck size={16} className="text-[#52884B]" /> Staff
										performance metrics
									</li>
									<li className="flex items-center gap-2 text-[#848484]">
										<MdCheck size={16} className="text-[#52884B]" /> Missed
										opportunity alerts
									</li>
								</ul>
							</div>
