  ...
  return (
    ...
    >
      <div className="w-full max-w-md mx-auto flex flex-col items-center">
        <h2 className="font-semibold text-[32px] leading-[40px] tracking-[-0.03em] mb-2 text-center">Connect Dentally</h2>
        ...
        {status === "idle" && (
          <div className="bg-[#FAF6DC] text-[#C29709] rounded-md px-6 py-3 text-center mb-6 text-sm font-medium">
            Pam will never edit patients&apos;s data without your permission.
          </div>
        )}
